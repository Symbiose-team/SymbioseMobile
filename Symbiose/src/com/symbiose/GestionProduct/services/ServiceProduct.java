 ...
 */
package com.symbiose.GestionProduct.services;
...
public class ServiceProduct {
    ...
    public boolean addProduct(Product ev){
     ...
     public void updateReponse(Product rep) {
            ...
            con.setUrl("http://localhost:8000/updateProductJSON/" +rep.getId()+ "/" +rep.getName()+ "/" +rep.getState()+ "/" +rep.getPrice()+ "/" +rep.getType()) ;// Insertion de l'URL de notre demande de connexion     
